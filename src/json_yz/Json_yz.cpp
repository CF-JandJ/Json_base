...
bool Json::operator == (const Json& other) {
	...
	case yazi::json::Json::Type::json_bool:
		return m_value.m_bool == other.m_value.m_bool;

	case yazi::json::Json::Type::json_int:
		return m_value.m_int == other.m_value.m_int;

	case yazi::json::Json::Type::json_double:
		return m_value.m_double == other.m_value.m_double;

	case yazi::json::Json::Type::json_string:
...
bool Json::has(int index) {
	if (m_type != Type::json_array) return false;
...
bool Json::has(const string& key) {
	if (m_type != Type::json_object) return false;

	return (m_value.m_object)->find(key) != (m_value.m_object)->end();
}

void Json::remove(int index) {
	if (m_type != Type::json_array)  return;
...
void Json::remove(const string& key) {
	if (m_type != Type::json_object) return;
